...
public class SongAdapterForGrid extends ArrayAdapter<Song> {
     ...
     */
    public SongAdapterForGrid(Activity context, ArrayList<Song> songs) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView backgroundView = (ImageView) listItemView.findViewById(R.id.lib_grid_background);
        // Get the image resource ID from the current AndroidFlavor object and
        // set the image to iconView
        backgroundView.setImageResource(currentSong.getImageResourceId());

        // Find the ImageView in the grid_item.xml layout with the ID list_item_icon
        ImageView iconView = (ImageView) listItemView.findViewById(R.id.lib_grid_centre);
        // Get the image resource ID from the current AndroidFlavor object and
        // set the image to iconView
        ...
        songNameTextView.setTextColor((currentSong.getTextColor()));
        ...
        artistTextView.setTextColor((currentSong.getTextColor()));
